...
public class PutReviewFavoriteResponseDto extends ResponseDto {

    private PutReviewFavoriteResponseDto() {
        super(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
    }

    public static ResponseEntity<PutReviewFavoriteResponseDto> success() {
        PutReviewFavoriteResponseDto result = new PutReviewFavoriteResponseDto();
